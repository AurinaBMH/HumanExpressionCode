...
try
    ...
    % read volumes
    Data(:, :, :,1) = nic_spm_read_vols(V(volumeIndex));
    ...
    %     nic_ShowOrientation(Head);%show the oritention of data, you can call the function in other function
...
%     cd(oldDir);
    ...
    rmpath(spmPath);
%     cd(oldDir);
    error('Meet error while reading the data');
end
