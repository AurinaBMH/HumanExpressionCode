function   [Rw] = rich_club_wu_strengthBINS(CIJ,varargin)
...
%if doBins
[E]  = BF_PlotQuantiles(NodeStrength, NodeStrength,100);
%else 
%[~, E] = discretize(NodeStrength,100); 
%end
...
for kk=2:length(E)
    SmallNodes=find(NodeStrength<E(kk));
