...
expressionlimma = BF_NormalizeMatrix(normExpression,'scaledRobustSigmoid');
...
figure;set(gcf,'color','w');
scatter(expressionlimma(:,geneIND),expressionSRS(:,geneIND),sz,C,'filled','MarkerEdgeColor',[.55 .55 .55],'LineWidth',1);
xlabel('limma', 'FontSize', 15); ylabel('SRS', 'FontSize', 15);
title(probeInformation.GeneSymbol{geneIND}, 'FontSize', 20); 
