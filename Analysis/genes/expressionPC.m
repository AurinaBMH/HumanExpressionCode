...
if uselimma
    cortexData = importlimmaExpression('limmanormalisedExpression.txt');
...
figure; h = scatter(x,y,S,A,'filled','MarkerEdgeColor',[.55 .55 .55],'LineWidth',0.7);
set(gcf,'color','w');
